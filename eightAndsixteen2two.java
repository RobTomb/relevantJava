...
public class eightAndsixteen2two extends JFrame{  

    sixteen2two ttb = new sixteen2two();
    eight2two ttw = new eight2two();
    ...
    public static void main(String[] args) {  
        eightAndsixteen2two win=new eightAndsixteen2two();  
    }  
      
    //构造函数  
    public eightAndsixteen2two(){  
